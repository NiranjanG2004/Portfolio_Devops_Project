...
import { FiMapPin, FiMail, FiPhone, FiLinkedin, FiGithub, FiDownload, FiEye, FiMessageSquare, FiX } from 'react-icons/fi';
    ...
    <section id="contact" className="py-20 px-4 md:px-20 scroll-mt-20 relative">
      ...
      <div className="container mx-auto relative z-20">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-4 max-w-2xl mx-auto">
            Have a question or want to work together? Feel free to reach out using the form below or chat with me live!
          </p>
        </motion.div>
      ...
      >
        <button
          ...
          className="p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 flex items-center space-x-2"
        ...
        {isChatOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 20 }}
            className="absolute bottom-16 right-0 bg-white dark:bg-gray-800 rounded-lg p-4 shadow-lg w-80"
          >
            <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-gray-600 dark:text-gray-400 mb-4">
              Hello! I'm currently available to chat. How can I help you today?
            </div>
            <textarea
              className="w-full p-2 bg-gray-200 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              rows="3"
              placeholder="Type your message..."
            ></textarea>
            <button
              className="mt-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all"
              onClick={() => alert('This is a simulated chat. Please use the contact form to send a message!')}
            >
              Send
            </button>
          </motion.div>
