...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-12 px-6 md:px-20 relative">
      <div className="container mx-auto relative z-20">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-6 max-w-2xl mx-auto">
            Explore my portfolio of projects and certifications showcasing my skills in web development, data science, and cloud architecture.
          </p>
        </motion.div>
